...
class UsageService {
  ...
  static Future<int> getStreak() async {
    ...
    DateTime lastOpenedRaw = days.first;
    DateTime lastOpened = DateTime(lastOpenedRaw.year, lastOpenedRaw.month, lastOpenedRaw.day);
    ...
    for (int i = 1; i < days.length; i++) {
      final prevDateRaw = days[i];
      final prevDate = DateTime(prevDateRaw.year, prevDateRaw.month, prevDateRaw.day);
